...
EMIT(option) {
  if (n->in_interface_option) {
    ...
    EMITOPTION(to_source)
  else EMITOPTION(state) else EMITOPTION(limit) else EMITOPTION(log_prefix) else EMITOPTION(sport) else EMITOPTION(uid_owner) else EMITOPTION(tcp_flags) else EMITOPTION(
      reject_with) else EMITOPTION(icmp_type) else EMITOPTION(fragment) else EMITOPTION(clamp_mss_to_pmtu) else EMITOPTION(helper) else EMITOPTION(syn) else {
